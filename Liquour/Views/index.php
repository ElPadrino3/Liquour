...
<body>
  ...
  <div class="page">
    ...
    <div class="summary-row" id="summaryRow">
      <div class="sum-card">
        <div class="sum-lbl">Total Ventas</div>
        <div class="sum-val"><span>$</span>4,218.00</div>
      </div>
      <div class="sum-card">
        <div class="sum-lbl">Transacciones</div>
        <div class="sum-val">24</div>
      </div>
      <div class="sum-card">
        <div class="sum-lbl">Promedio / Venta</div>
        <div class="sum-val"><span>$</span>175.75</div>
      </div>
      <div class="sum-card">
        <div class="sum-lbl">Vendedores</div>
        <div class="sum-val">3</div>
      </div>
    </div>
